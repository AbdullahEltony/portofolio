        ...
        return (
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center md:flex-row gap-x-8 h-full">
              ...
              xl:justify-center items-center mx-auto xl:mx-0 mb-[20px] lg:mb-0"
              >
                <div>
                  {/*avatar*/}
              ...
              {/* quate & messages */}
              <div
                className="flex-1 flex-col justify-center before:w-[1px] xl:before:bg-white/20 xl:before:absolute xl:before:left-0 xl:before:h-[200px]
                relative xl:pl-20 px-[40px]"
              >
                {/* quote icon */}
                <div className="mb-4">
